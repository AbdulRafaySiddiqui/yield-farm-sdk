...
export const PROJECT_HANDLER_ADDRESS = process.env.REACT_APP_PROJECT_HANDLER as string
...
export const POOL_CARDS_ADDRESS = process.env.REACT_APP_POOL_CARDS_ADDRESS as string